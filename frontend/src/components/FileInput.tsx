...
export default function FileInput(props: JSX.IntrinsicAttributes & ClassAttributes<HTMLInputElement> & InputHTMLAttributes<HTMLInputElement>) {
  return (
    <div className="relative inline-block text-left w-full" {...props}>
      <label htmlFor='upload' className='py-[11px] leading-[19px] px-4 bg-[#F01414]/[0.3] bg-opacity-40 rounded-xl focus:outline-none focus:border-[#7481F6] flex items-center justify-between w-full hover:cursor-pointer'>
