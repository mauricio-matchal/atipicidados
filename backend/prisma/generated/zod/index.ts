...
export const PacienteScalarFieldEnumSchema = z.enum(['id','analise','nome','cpf','rg','nascimentodata','nomemae','nomepai','unidadeId','email','telefone','rgdocfile','fotofile','compresfile','laudofile','relescolar','gestacao','nascimento','autonomia','comportamento','desenvolimento','pedagogico','geral','mae','pai','maisinfo','escola','saudeinfo','raca']);
...
export const PacienteWhereUniqueInputSchema: z.ZodType<Prisma.PacienteWhereUniqueInput> = z.object({
  id: z.number().int()
})
.and(z.object({
  id: z.number().int().optional(),
